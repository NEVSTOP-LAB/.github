...
| [CSM API String Arguments Support](https://github.com/NEVSTOP-LAB/CSM-API-String-Arugments-Support) | Support of Static Variables which are loaded from ini configuration file for CSM. |NOT PUBLISHED YET|
