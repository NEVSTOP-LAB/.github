...
```mermaid
    ...
    bar   [6545, 5065, 4275, 4765, 3927, 2512, 2026.06]
...
[`csm-modsets(8)`](https://github.com/search?q=topic:csm-modsets%20org:NEVSTOP-LAB%20is:public&type=Repositories)
...
<a href="https://github.com/NEVSTOP-LAB">NEVSTOP-LAB</a> (8)
  <a href="https://github.com/NEVSTOP-LAB/CSMScript-Lite">CSMScript-Lite</a> ⭐21 CSMScript Lite版本，一款轻量级脚本执行引擎，用于执行灵活的 CSM 测试脚本
