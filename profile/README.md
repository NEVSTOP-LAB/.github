...
```mermaid
    ...
    bar   [6423, 4973, 4182, 4669, 3855, 2432, 2026.05]
...
<a href="https://github.com/NEVSTOP-LAB">NEVSTOP-LAB</a> (7)
  <a href="https://github.com/NEVSTOP-LAB/CSMScript-Lite">CSMScript-Lite</a> ⭐20 CSMScript Lite版本，一款轻量级脚本执行引擎，用于执行灵活的 CSM 测试脚本
